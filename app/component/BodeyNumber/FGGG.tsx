    ...
    return (
        <>
            <div className='w-full h-[60px] flex items-center justify-center' >
                <div className='text-[#161C24] text-[32px] max-lg:text-[24px] font-[700px] max-lg:text-center max-lg:mb-14'>خطوط پیامکی اختصاصی در <span className='text-[#14A39A]'>پنل من</span></div>
            </div>

            <div className='w-full h-[60px] flex items-center justify-center mt-[4%]' >
                <div className='text-[#637181] text-[18px] max-lg:text-center font-[500px] w-[1028px] max-lg:w-[80%] h-[88px] leading-[44px] flex items-center justify-center'>خطوط اختصاصی ارسال پیامک های تبلیغاتی ، همانند اپراتورهای تلفن همراه ، با شماره های متفاوتی ارائه می شوند .
            ...
            <div className='w-full h-[524px] relative mt-4 max-lg:mt-[150px] flex'>
                <div className="w-[58%] max-lg:w-[60%]">
                    <div className="h-[35%] flex items-end justify-end max-lg:items-start max-lg:justify-end">
                ...
                <div className='w-[42%] max-lg:w-[40%]'>
                    <Image
                ...
                <div className="w-full h-full absolute top-[-50%] z-10 ">
                    <div className='w-full h-[616px] flex flex-col mt-[100px]'>
                        <div className='flex flex-col justify-center items-center gap-10 w-full h-full'>
                            ...
                            <div className='w-[855px] max-lg:w-[90%] h-[558px]'>
            ...
            <div className="w-full h-[1200px] flex relative">
                ...
                <div className="w-[80%]">
                    ...
                    <div className="h-[700px] absolute w-[1200px] max-lg:w-[90%] top-[27%] left-[7%]">
