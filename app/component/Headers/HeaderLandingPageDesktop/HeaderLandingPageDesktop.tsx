...
function HeaderLandingPageDesktop() {
    return (
        <div className='px-[60px] pt-[2%]'>
            <div className='h-[200px] w-full relative'>
                <div className='absolute w-full h-full z-10'>
                    <div className='flex w-full h-[60px]'>
                        <div className='w-[20%] h-full text-[36px] font-[700px] text-[#161C24]'>پنل <span className="text-[#14A39A]">من</span></div>
                        <div className='text-[#637381] font-[500px] text-[16px] flex w-full h-full  items-center'>
